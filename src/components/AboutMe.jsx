    ...
    <>
      <div className="container mx-auto mb-20">
        ...
        <div className="grid grid-cols-12  gap-3">
          <div className="md:col-span-12 lg:col-span-4 text-center md:px-16">
            <img src="https://thriving-dragon-a3fcd9.netlify.app/assets/about-pic.png" alt="image" className="rounded-[50px]"/>
          </div>
          <div className="md:col-span-12 lg:col-span-8 p-16">
